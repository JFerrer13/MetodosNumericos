Vue.component('regulafalsi', {
    template: //html
    `
    <div class="row" name="Regula Falsi">
    ...
    methods: {
        ...
        calcularTerminoPolinomial: function(termino){
            ...
            //console.log(" new fxd " + nuevoTermino.fxd);
            nuevoTermino.xm = ((nuevoTermino.fxi * nuevoTermino.xd) - (nuevoTermino.fxd * nuevoTermino.xi))/(nuevoTermino.fxi - nuevoTermino.fxd);
           ...
           // console.log("new e" + nuevoTermino.e + " Number(this.e)= " + Number(this.e) + "termino.xm?" +termino.xm) ;
        ...
        calcular: function (){
            ...
            if(!isNaN(Number(this.a)) && !isNaN(Number(this.b)) && !isNaN(Number(this.e)) && Number(this.e) > 0 ){
                this.tbValores = [{
                    ...
                    xd: Number(this.b),
                    xm: 0,
                    fxd: app.calcularValoresPolinomial(Number(this.b), this.terminos),
                    fxi: app.calcularValoresPolinomial(Number(this.a), this.terminos),
        ...
        dibujarGráfica(){
            ...
            this.tbValores = _.sortBy(this.tbValores, 'xm');
            console.log(this.tbValores);
            for (let i = 0; i < this.tbValores.length; i++) {
                const element = this.tbValores[i];

                fmx.push({ "x": this.truncarValor(this.tbValores[i].xm), "y": this.truncarValor(this.tbValores[i].fxm)});
                fmd.push(this.truncarValor(this.tbValores[i].fxd));
                fmi.push(this.truncarValor(this.tbValores[i].fxi));

                ejey.push({"x": this.truncarValor(minX + (i * (maxX - minX)/this.tbValores.length)), "y": this.truncarValor(app.calcularValoresPolinomial(minX + (i * (maxX - minX)/this.tbValores.length), this.terminos))});
            ...
            this.tbValores = _.sortBy(this.tbValores, 'xm').reverse();
        },
